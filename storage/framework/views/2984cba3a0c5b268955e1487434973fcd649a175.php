<section class="border-b border-gray-100">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:py-28 sm:px-6 lg:px-8">
        <div class="lg:text-center">
            <h2 class="text-base text-secondary font-semibold tracking-wide uppercase"><?php echo e(__('Testimonials')); ?></h2>
        ...
        <div class="w-full lg:flex items-center gap-6 mt-10">
            ...
            <div class="lg:w-1/2 mt-10 lg:mt-0">
                <div class="bg-white border rounded-md border-gray-200 relative sm:p-10 p-6">
                    ...
                    <p class="text-base leading-6 text-gray-600 mt-4"><?php echo e(${"testimonial".$i}[2]); ?></p>
                ...
                <div class="flex items-center mt-7">
                    <div class="w-12 h-12 border border-primary rounded-full flex items-center justify-center">
                        <img src="<?php echo e(${"testimonial".$i}[3]); ?>" class="w-10 h-10 rounded-full" alt="<?php echo e(${"testimonial".$i}[0]); ?>"/>
                    </div>
                    <div class="flex flex-col items-start ltr:ml-4 rtl:mr-4">
                        <p class="text-base font-semibold leading-4 text-gray-800"><?php echo e(${"testimonial".$i}[0]); ?></p>
                        <p class="text-base leading-4 mt-2 text-center text-gray-600"><?php echo e(${"testimonial".$i}[1]); ?></p>
                    </div>
                </div>
            </div>
