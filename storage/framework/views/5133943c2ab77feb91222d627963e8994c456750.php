...
<div class="max-w-7xl mx-auto  px-4 sm:px-6 lg:px-8">
    <div class="container  mb-30 p-6">
        <div class="text-center mb-10">
            <h1 class="text-2xl font-bold">How We Create Great Results</h1>
        </div>
        ...
        <div class="text-center">
            <div class="mt-10 md:1/6">
                <a href="<?php echo e(route('register')); ?>"
                    class="block bg-primary py-2 px-6 text-white text-lg rounded-md hover:bg-secondary">Sign Up for Free
                    Tests</a>
            </div>
        </div>
    </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-4 border-b ">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab"
            ...
            <li class="me-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600  dark:hover:text-gray-300"
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Get all tab buttons and tab content panels
...
<style>
    [role="tab"] {
        ...
        /* Add transparent bottom border to all tabs */
    ...
    [role="tab"].active {
        ...
        /* Remove other border styles to avoid conflicting styles */
        border-left: none !important;
        border-right: none !important;
        border-top: none !important;
    }

    /* Apply primary color to active tab text */
    [role="tab"].active .text-primary {
        color: var(--primary-color);
        /* Use primary color for active tab text */
        border-left: none !important;
        border-right: none !important;
        border-top: none !important;
    }
