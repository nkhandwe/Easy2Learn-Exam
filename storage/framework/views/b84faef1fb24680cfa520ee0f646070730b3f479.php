<?php if($homePageSettings->enable_top_bar): ?>
        ...
        <div x-bind:class="!barOpen ? 'hidden' : ''" class="max-w-7xl mx-auto py-1 px-3 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between flex-wrap">
                ...
                <div class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
                    <a href="<?php echo e($topBar->button_link); ?>" target="_blank"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\resources\views/components/top-bar.blade.php ENDPATH**/ ?>