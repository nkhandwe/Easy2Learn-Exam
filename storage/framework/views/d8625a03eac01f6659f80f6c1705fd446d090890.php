        ...
        <div class="flex flex-col sm:flex-col md:flex-row lg:flex-row">
            <div class="hidden mt-6 md:mt-0 h-96 md:h-auto md:w-1/2 relative lg:mt-0 ltr:pr-6 rtl:pl-6 sm:ltr:pl-20 sm:rtl:pl-20 sm:flex justify-end sm:block">
                <div class="w-5/6 h-full">
                    <img class="inset-0 absolute object-contain object-bottom z-10 w-auto h-full pt-10" src="<?php echo e(asset('storage/'.$hero->image_path)); ?>" alt="Hero Image" role="img" />
                </div>
            </div>
            <div class="flex flex-col items-start lg:w-6/12 md:w-6/12 px-4 lg:px-0 md:ml-8 justify-center py-12 sm:py-36">
                <?php if($least_price): ?>
                    <div class="mb-6 py-1.5 px-4 flex items-center justify-start bg-secondary rounded-full text-sm font-semibold text-white">
                        ...
                        <span class="pl-2"><?php echo e(__('Subscription starts from')); ?> <?php echo e($least_price); ?>/<?php echo e(__('month')); ?></span>
                    </div>
                <?php endif; ?>
                <h1 class="text-5xl sm:text-5xl md:text-4xl lg:text-5xl font-bold leading-tight text-primary dark:text-white"><?php echo e($category['headline'] ?: $category['name']); ?></h1>
                <p class="text-lg text-gray-600 leading-relaxed pt-8 xl:hidden block"><?php echo e($category['short_description']); ?></p>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\resources\views/components/category-hero.blade.php ENDPATH**/ ?>