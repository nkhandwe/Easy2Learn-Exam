<template>
    <div class="h-screen max-h-screen overflow-hidden select-none">
        ...
        <!-- Header ends -->
        <!-- Section starts -->
        <div class="z-20 h-16 w-full mx-auto absolute top-16 left-0 bg-white border-b border-gray-200 flex justify-between items-center px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-no-wrap bg-white">
            ...
            <div class="w-96 overflow-hidden absolute sm:relative md:h-full flex-col justify-between hidden border-l border-gray-100 sm:flex sm:flex-col transition duration-150 ease-in-out">
                ...
                <perfect-scrollbar class="h-screen max-h-screen px-4 sm:px-6 lg:px-8 pt-32 pb-72 bg-gray-50 border-l border-gray-200" ref="scroll" :options="scrollbarOptions">
            ...
            <div class="w-80 h-full z-40 absolute bg-gray-50 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out" ref="mobileNav">
                ...
                <perfect-scrollbar class="h-screen max-h-screen overflow-hidden px-4 pt-32 pb-72" ref="scroll" :options="scrollbarOptions">
                    <slot name="questions"></slot>
                </perfect-scrollbar>
