        ...
        <div class="card">
            <div class="card-body">
                <vue-good-table mode="remote" @on-page-change="onPageChange" @on-column-filter="onColumnFilter" @on-per-page-change="onPerPageChange"
                                ...
                                :rows="examSessions.data" :rtl="$page.props.rtl" :line-numbers="true">
                    <template slot="table-row" slot-scope="props">
                        ...
                        <div class="py-2" v-else-if="props.column.field === 'actions'">
                            <inertia-link class="qt-btn qt-btn-sm qt-btn-success" :href="route('exam_results', {exam: props.row.slug, session: props.row.id})">
                                {{ __('Results') }}
                            </inertia-link>
                        </div>
