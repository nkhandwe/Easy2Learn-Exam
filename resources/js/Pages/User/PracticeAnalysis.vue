    ...
    <app-layout>
        ...
        <div class="py-8">
            <div class="w-full flex flex-col justify-center items-center">
                <div v-if="practiceSet.allow_rewards && session.status !== 'completed'" class="w-full font-mono px-4 py-2 border border-green-200 bg-green-100 text-green-600 rounded text-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="flex gap-4 justify-between border-b border-gray-100 items-center h-16 px-4 py-4">
                            <div class="flex items-center gap-2">
                                ...
                                <h4 class="font-semibold text-sm" v-if="session.status === 'completed' && allowRewards">{{ __('Points Earned') }}</h4>
                                <h4 class="font-semibold text-sm" v-else>{{ __('Score') }}</h4>
                            </div>
                                    ...
                                    <div :id="question.code" v-show="current_question === index">
                                        <div class="flex justify-between items-center mb-6">
                                            ...
                                            <div v-if="question.status === 'answered'" :class="question.is_correct ? 'bg-green-400' : 'bg-red-400'"
                                                ...
                                                <span v-if="question.is_correct">+{{ question.points_earned }} {{ __('Points') }}</span>
