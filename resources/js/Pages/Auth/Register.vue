<template>
    <auth-layout>
        <h1 class="mt-8 text-xl sm:text-2xl font-semibold text-black tracking-ringtighter title-font">{{ __('Register New Account') }}</h1>
        ...
        <div class="mb-6 text-sm text-center">
            ...
            <inertia-link class="underline text-secondary" :href="route('login')">{{ __('Login') }}</inertia-link>
        </div>
    </auth-layout>
</template>
