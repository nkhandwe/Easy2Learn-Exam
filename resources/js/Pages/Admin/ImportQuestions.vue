    ...
    <admin-layout>
        ...
        <div class="py-12">
            <div class="w-full mx-auto md:w-10/12 lg:w-8/12 xl:w-6/12 md:pb-0 md:px-6" >
                <div class="bg-red-200 shadow rounded-md md:flex justify-between items-center top-0 mt-12 mb-8 pb-4 px-4" v-if="hasErrors">
                ...
                <div class="bg-white rounded shadow">
                    <div class="flex justify-end w-full p-2 border-b border-gray-200">
                        <a :href="sampleFileUrl"
                            ...
                            <span class="ltr:pl-2 rtl:pr-2 text-sm font-bold text-gray-600">{{ __("Download Sample Excel") }}</span>
                        </a>
                    </div>
                    <div class="p-6">
                        <form @submit.prevent="submit" enctype="multipart/form-data">
                            ...
                            <!--<div class="flex flex-col w-full mb-6">
                                              ...
                                              <div class="form-control-errors">
                                                  <p v-if="errors.topic_id" role="alert" class="pt-2 text-xs text-red-500">{{ errors.topic_id }}</p>
                                              </div>
                                          </div>-->
                            <div class="flex flex-col w-full mb-6">
                                <input
                    ...
                    <div class="w-full p-6">
                        ...
                        <table class="w-full table-auto">
                            ...
                            <tr>
                                ...
                                <th class="border border-emerald-500 px-4 py-2 text-emerald-600 font-medium text-sm text-center">
                                    {{ __("Acceptable Code") }}
                                </th>
                            </tr>
                            </thead>
                            ...
                            <tr v-for="questionType in questionTypes">
                                ...
                                <td
                                    ...
                                    <Tag
                                        ...
                                        icon="pi pi-copy"
                                        v-clipboard:copy="questionType.code"
                            ...
                            <tr v-for="difficultyLevel in difficultyLevels">
                                ...
                                <td class="border border-emerald-500 px-4 py-2 text-emerald-600 font-medium text-sm text-center">
                                    <Tag
                                        ...
                                        class="text-sm cursor-pointer w-28 p-mr-2"
                                        icon="pi pi-copy"
                                        v-clipboard:copy="difficultyLevel.code"
                                        v-clipboard:success="handleCopyStatus"
                                    />
                                </td>
                            </tr>
...
<script>
    ...
    export default {
        ...
        methods: {
            submit() {
                ...
                if (this.skill_id !== null && this.file !== null) {
                    ...
                    this.$inertia.post(
                        route("import_questions", {skill: this.skill_id}),
                        formData,
                        {
                            onSuccess: () => {
        ...
        computed: {
            title() {
                return (
                    this.__("Import Questions")+" - " + this.$page.props.general.app_name
                );
            },
            hasErrors() {
