    ...
    <arc-action-section>
        ...
        <template #content>
            ...
            <div class="flex items-center mt-5">
                ...
                <arc-action-message :on="form.recentlySuccessful" class="ml-3">
                    {{ __('Done') }}.
                </arc-action-message>
            </div>

            <!-- Logout Other Devices Confirmation Modal -->
            <arc-dialog-modal :show="confirmingLogout" @close="closeModal">
                <template #title>
                    {{ __('Logout Other Browser Sessions') }}
                </template>

                <template #content>
                    {{ __('browser_session_consent') }}
                ...
                <template #footer>
                    ...
                    <arc-button class="ml-2" @click.native="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        {{ __('Logout Other Browser Sessions') }}
                    </arc-button>
                </template>
            </arc-dialog-modal>
