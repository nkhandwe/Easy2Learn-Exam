<template>
    <div class="mma-options">
        <div class="mb-4" v-for="(option, index) in options" :key="index">
            ...
            <ckeditor :id="'option_text_'+index" :editor-url="editorUrl" :config="editorConfig" v-model="options[index].option" :class="[$page.props.rtl ? 'cke_rtl' : 'cke_ltr']"></ckeditor>
            <div class="flex bg-gray-50 border-b border-l border-r border-gray-300 justify-between items-center px-4 py-2">
                <div class="flex gap-1 items-center">
                    <input type="checkbox" @change="selectAnswer" class="custom-control-input" :id="'option-'+index" v-model="correct_answer" :value="index+1">
