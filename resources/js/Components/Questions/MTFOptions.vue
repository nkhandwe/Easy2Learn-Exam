    ...
    <div class="mtf-options">
        ...
        <div class="my-4" v-for="(option, index) in options" :key="index">
            ...
            <div class="w-full grid grid-cols-2 bg-white">
                <ckeditor class="w-full" :id="'option_text_'+index" :editor-url="editorUrl" :config="editorConfig" v-model="options[index].option" :class="[$page.props.rtl ? 'cke_rtl' : 'cke_ltr']"></ckeditor>
                <ckeditor class="w-full" :id="'option_pair_'+index" :editor-url="editorUrl" :config="editorConfig" v-model="options[index].pair" :class="[$page.props.rtl ? 'cke_rtl' : 'cke_ltr']"></ckeditor>
            </div>
