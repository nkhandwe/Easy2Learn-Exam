    ...
    <div class="audio-options">
        ...
        <div class="w-full flex flex-col mb-6">
            ...
            <div class="p-inputgroup">
                <InputText id="video_link" @input="selectOptions" v-model="options.link" :placeholder="options.video_type === 'mp4' ? __('Video Link') : __('Video')+' ID'" aria-describedby="video_link-help" />
                <Button type="button" @click="showPlayer" icon="pi pi-play" :label="__('Preview')" />
            </div>
        </div>
        <div v-if="player" class="my-4 flex justify-end">
            <Button type="button" class="p-button-text" @click="player = false" icon="pi pi-times" :label="__('Close')" />
        </div>
