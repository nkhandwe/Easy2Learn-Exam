    ...
    <div class="overflow-y-auto h-screen px-2">
        ...
        <form v-else class="my-6 w-11/12 mx-auto xl:w-full xl:mx-0" @submit.prevent="submitForm">
            ...
            <div class="w-full flex flex-col mb-6">
                <label for="title" class="pb-2 font-semibold text-gray-800">{{ __('Comprehension') }} {{ __('Title') }}</label>
                <InputText type="text" id="title" v-model="form.title" aria-describedby="name-help"
            ...
            <div class="w-full flex flex-col mb-6">
                ...
                <ckeditor id="body" :config="editorConfig" :editor-url="editorUrl" v-model="form.body" :class="[$page.props.rtl ? 'cke_rtl' : 'cke_ltr', errors.body ? 'p-invalid' : '']"></ckeditor>
