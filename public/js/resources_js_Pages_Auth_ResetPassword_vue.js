...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ArcAuthenticationCard: _Components_AuthenticationCard__WEBPACK_IMPORTED_MODULE_0__["default"],
    ArcButton: _Components_Button__WEBPACK_IMPORTED_MODULE_1__["default"],
    ArcInput: _Components_Input__WEBPACK_IMPORTED_MODULE_2__["default"],
  ...
  computed: {
    title: function title() {
      return this.__('Reset Password') + ' - ' + this.$page.props.general.app_name;
    }
  },
  methods: {
      ...
      scopedSlots: _vm._u([
        {
          ...
          fn: function () {
            return [
              _c("inertia-link", { attrs: { href: _vm.route("welcome") } }, [
                _c("img", {
                  staticClass: "h-12",
                  attrs: {
                    src:
