...
/* harmony import */ var _Components_ValidationErrors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/Components/ValidationErrors */ "./resources/js/Components/ValidationErrors.vue");
/* harmony import */ var _Components_AuthenticationCard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/Components/AuthenticationCard */ "./resources/js/Components/AuthenticationCard.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ...
    ArcAuthenticationCard: _Components_AuthenticationCard__WEBPACK_IMPORTED_MODULE_3__["default"],
    ArcCheckbox: _Components_Checkbox__WEBPACK_IMPORTED_MODULE_1__["default"],
    ArcValidationErrors: _Components_ValidationErrors__WEBPACK_IMPORTED_MODULE_2__["default"],
    ...
    ArcButton: _Components_Button__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  props: {
    settings: Object,
  ...
  methods: {
    ...
    fillCredentials: function fillCredentials(role) {
      if (role === 'admin') {
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._v(_vm._s(_vm.__("Login To Your Account")))]
      ),
      _vm._v(" "),
      ...
      _c(
        ...
        [
          ...
          _c(
            "div",
            { staticClass: "mt-8 w-full flex justify-between" },
            [
              _c(
                "label",
                ...
                [
                  ...
                  _c(
                    "span",
                    { staticClass: "ltr:ml-2 rtl:mr-2 text-sm text-gray-600" },
                    [_vm._v(_vm._s(_vm.__("Remember me")))]
                  ),
                ],
                1
              ),
      ...
      _vm._v(" "),
      _vm.$page.props.isDemo
        ? _c(
            "div",
            {
              staticClass:
                "mt-8 justify-between items-center flex gap-4 flex-wrap",
            },
            [
              _c("span", { staticClass: "text-sm" }, [_vm._v("Login To:")]),
              _vm._v(" "),
              _c(
                "button",
                {
                  staticClass: "qt-btn qt-btn-sm qt-btn-primary",
                  on: {
                    click: function ($event) {
                      return _vm.fillCredentials("admin")
                    },
                  },
                },
                [_vm._v("Admin")]
              ...
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function ($event) {
                      return _vm.fillCredentials("instructor")
                    },
                  },
                },
                [_vm._v("Instructor")]
              ...
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function ($event) {
                      return _vm.fillCredentials("student")
                    },
                  },
                },
                [_vm._v("Student")]
              ...
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function ($event) {
                      return _vm.fillCredentials("guest")
                    },
                  },
                },
                [_vm._v("Guest")]
        ...
        : _vm._e(),
      _vm._v(" "),
      !_vm.$page.props.isDemo && _vm.$page.props.general.can_register
      ...
      !_vm.$page.props.isDemo && _vm.$page.props.general.can_register
        ? _c(
            ...
            [
              _c("span", [
                _vm._v(_vm._s(_vm.__("Don’t Have An Account?")) + " "),
              ]),
              _vm._v(" "),
              _c(
                "inertia-link",
